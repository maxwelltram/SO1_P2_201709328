...
type GetInfoClient interface {
	ReturnInfo(ctx context.Context, in *Calificacion, opts ...grpc.CallOption) (*ReplyInfo, error)
}
...
func (c *getInfoClient) ReturnInfo(ctx context.Context, in *Calificacion, opts ...grpc.CallOption) (*ReplyInfo, error) {
	out := new(ReplyInfo)
...
type GetInfoServer interface {
	ReturnInfo(context.Context, *Calificacion) (*ReplyInfo, error)
...
func (UnimplementedGetInfoServer) ReturnInfo(context.Context, *Calificacion) (*ReplyInfo, error) {
...
func _GetInfo_ReturnInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GetInfoServer).ReturnInfo(ctx, req.(*Calificacion))
	}
